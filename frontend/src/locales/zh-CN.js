const zhCN = {
  ...
  setup: {
    ...
    retrieval: {
      ...
      optionalApiKeyHint:
        '如果你的本地服务不需要 key，可以留空。功能关闭或切走后，对应隐藏字段会被显式清空。',
    ...
    messages: {
      ...
      remoteProfileIncomplete: '请先补全远端检索配置所需字段，再保存本地 .env。',
      remoteProfileUsesExamples: '请把预设里的示例 router 地址和模型名替换成你的真实配置后再保存。',
  ...
  memory: {
    ...
    layerHierarchy: {
      title: '记忆层级',
      subtitle: '探索记忆层次：L0 访问日志、L1 原子记忆、L2 摘要',
      loading: '加载中...',
      loadingDetail: '加载详情...',
      refresh: '刷新',
      mockBadge: '模拟数据',
      layerStatsHeading: '层级统计',
      summariesHeading: 'L2 摘要',
      noSummaries: '暂无摘要',
      provenanceHeading: '来源追溯',
      sourceMemoriesHeading: '源记忆',
      noSources: '未找到源记忆',
      noContent: '无内容',
      noL1Loaded: '选择摘要以查看源记忆',
      untitledSummary: '未命名摘要',
  ...
  review: {
    ...
    orphan: {
      kicker: '不可逆删除',
      title: '记忆已完全孤立',
      body: '没有其他路径指向这条记忆。删除将永久移除全部访问入口，搜索结果中也无法再检索到原始内容。',
      irreversible: '此操作无法撤销',
    },
    paths: {
      sectionLabel: '存活路径',
      summary_one: '该记忆仍可通过 {{count}} 条路径访问',
      summary_other: '该记忆仍可通过 {{count}} 条路径访问',
      copy: '复制 URI',
      copyUri: '复制 URI {{uri}}',
      copied: '已复制',
      copyFailed: '复制失败',
  ...
  maintenance: {
    ...
    shared: {
      selectionSummary: '已选择 {{selected}} 项 · {{actionable}} 项可操作',
      clearSelection: '清除选择',
      retry: '重试',
      noResults: '无结果',
      loadingCandidates: '正在加载候选项……',
      lastUpdated: '上次扫描 {{time}}',
      resetFilters: '重置筛选条件',
    ...
    orphan: {
      selectionRegion: '已选孤儿记忆',
      selectMemory: '选择记忆 #{{id}}（{{label}}）',
      deselectMemory: '取消选择记忆 #{{id}}（{{label}}）',
      selectGroup: '全选{{group}}',
      deselectGroup: '取消全选{{group}}',
    },
    ...
    vitality: {
      ...
      pathPrefix: '路径前缀',
      reviewer: '审核人',
      reviewerPlaceholder: '审核人标识（默认：{{value}}）',
      optional: '（可选）',
      applyFilters: '应用筛选',
      resetFilters: '重置为默认值',
      confirmModal: {
        title: '确认清理',
        body: '您即将 {{action}} {{count}} 条记忆。此操作需要确认。',
        body_one: '您即将 {{action}} {{count}} 条记忆。此操作需要确认。',
        body_other: '您即将 {{action}} {{count}} 条记忆。此操作需要确认。',
        phrasePrompt: '请输入以下确认短语以继续：',
        cancel: '取消',
        confirm: '确认',
      },
      ...
      reviewId: '审核 ID：{{value}}',
      action: '操作：{{value}}',
      reviewerValue: '审核人：{{value}}',
      confirmationPhrase: '确认短语：{{value}}',
      degradedStatus: '状态：降级',
      reason: '原因：{{value}}',
      status: '状态：{{value}}',
      resultSummary: '已删除={{deleted}} 已保留={{kept}} 已跳过={{skipped}} 错误={{errors}}',
      loading: '正在加载活力候选……',
      noCandidates: '当前筛选条件下没有活力候选。',
      vitality: '活力值 {{value}}',
      inactive: '不活跃 {{value}} 天',
      access: '访问 {{value}}',
      selectCandidate: '选择候选 #{{id}}（{{uri}}）',
      deselectCandidate: '取消选择候选 #{{id}}（{{uri}}）',
      deletable: '可删除',
      activePaths: '仍有活动路径',
      noPath: '（无路径）',
      selectionRegion: '已选活力清理候选',
    },
    forgetting: {
      title: '遗忘模拟',
      subtitle: '预览记忆衰减并审查归档候选',
      loading: '加载中...',
      refresh: '刷新',
      mockBadge: '模拟数据',
      simulationHeading: '衰减模拟',
      daysLabel: '预测天数',
      thresholdLabel: '归档阈值',
      projectedRetained: '预计保留',
      projectedArchived: '预计归档',
      decayUnavailable: '衰减模拟数据暂不可用',
      distribution: {
        title: '分数分布',
        threshold: '阈值',
        bucketLabel: '{{range}}',
      ...
      summary: {
        ...
        projectedArchived: '预计归档数',
        projectedRetained: '预计保留数',
        simulationDays: '模拟天数',
      },
      queueHeading: '归档候选队列',
      noCandidates: '无低于阈值的候选记忆',
      currentScore: '当前分数',
      projectedScore: '预测分数',
      lastAccessed: '最后访问',
      inspect: '查看',
      ...
      select: '选择',
      deselect: '取消选择',
      selectCandidate: '选择记忆 #{{id}}（{{title}}）',
      deselectCandidate: '取消选择记忆 #{{id}}（{{title}}）',
      batchKeep: '批量保留',
      batchArchive: '批量归档',
      unnamedMemory: '未命名记忆',
      confirmArchive: '确认归档 {{count}} 条已选记忆？',
      confirmArchive_one: '确认归档 {{count}} 条已选记忆？',
      confirmArchive_other: '确认归档 {{count}} 条已选记忆？',
      executeArchive: '请输入确认短语以归档已选记忆：\n{{phrase}}',
      decayChartLabel: '记忆 #{{id}} 的衰减曲线',
      outOfTotal: '共 {{count}} 条',
      reason: '原因：{{value}}',
      selectedCount: '已选择 {{count}} 条',
      simulationDays: '模拟 {{count}} 天',
      simulationDays_one: '模拟 {{count}} 天',
      simulationDays_other: '模拟 {{count}} 天',
      selectionRegion: '已选遗忘候选',
      recommendations: {
        archive: '归档',
        keep: '保留',
        review: '审查',
      ...
      errors: {
        ...
        loadSimulation: '加载衰减模拟失败',
      },
      messages: {
        archiveFailed: '归档 {{count}} 条记忆失败',
        archiveFailed_one: '归档 {{count}} 条记忆失败',
        archiveFailed_other: '归档 {{count}} 条记忆失败',
        archived: '已归档 {{count}} 条记忆',
        archived_one: '已归档 {{count}} 条记忆',
        archived_other: '已归档 {{count}} 条记忆',
        archivedMock: '已归档 {{count}} 条记忆（模拟）',
        archivedMock_one: '已归档 {{count}} 条记忆（模拟）',
        archivedMock_other: '已归档 {{count}} 条记忆（模拟）',
        inspectQueued: '已将记忆 #{{id}} 加入检查队列',
        keepBatchFailed: '批量保留 {{count}} 条记忆失败',
        keepBatchFailed_one: '批量保留 {{count}} 条记忆失败',
        keepBatchFailed_other: '批量保留 {{count}} 条记忆失败',
        keepFailed: '保留记忆 #{{id}} 失败',
        kept: '记忆 #{{id}} 已保留',
        keptBatch: '已保留 {{count}} 条记忆',
        keptBatch_one: '已保留 {{count}} 条记忆',
        keptBatch_other: '已保留 {{count}} 条记忆',
      },
    },
  },
  observability: {
    ...
    messages: {
      ...
      cancelJobNotFoundDetail: '任务不存在',
      cancelAlreadyFinalizedDetail: '任务已结束',
    ...
    searchQuality: {
      ...
      p95: 'p95 延迟',
      mrrTrend: 'MRR 趋势',
      recallTrend: 'Recall 趋势',
      latencyTrend: '延迟趋势',
      notAvailable: '暂无',
      notEnoughData: '数据不足',
      perModeHeading: '各模式指标',
      channelHeading: '通道贡献',
      channels: {
        fts5: 'FTS5 关键词',
        vector: '向量语义',
      ...
      contributionExplain: '各通道对最终结果的贡献百分比',
      rrfHeading: 'RRF 配置',
      rrfStatus: '状态',
      rrfEnabled: '已启用',
      rrfDisabled: '已禁用',
      ...
      rrfReason: '原因：{{value}}',
      lastUpdated: '最近更新',
      sampleCount: '样本数：{{count}}',
      sparklineMax: '最大值',
      sparklineMin: '最小值',
      weight: '权重：{{value}}',
      windowDays: '{{count}} 天窗口',
      timeSeriesHeading: '质量趋势',
      errors: {
        loadMetrics: '加载搜索质量指标失败',
      },
    },
    modes: {
      hybrid: '混合',
    ...
    strategies: {
      factual_high_precision: '事实高精度',
      exploratory_high_recall: '探索高召回',
      temporal_time_filtered: '时序过滤',
      causal_wide_pool: '因果广覆盖',
      default: '默认',
      unknown: '未知',
    },
  },
  apiErrors: {
    ...
    codes: {
      ...
      config_value_invalid_line_break: '配置值不能包含换行符',
      no_config_changes: '没有提供任何配置改动',
      ...
      invalid_domain: '记忆域无效',
      read_only_domain: '记忆域为只读',
      path_too_long: '记忆路径过长',
      path_not_found: '未找到记忆路径',
      create_node_failed: '创建记忆节点失败',
      memory_version_conflict: '记忆版本冲突',
      update_node_failed: '更新记忆节点失败',
      delete_node_failed: '删除记忆节点失败',
      invalid_session_id: '审查会话 ID 无效',
      newer_review_snapshot_exists: '存在更新的审查快照',
      session_snapshots_not_found: '未找到审查会话快照',
      snapshot_not_found: '未找到审查快照',
      version_chain_mismatch: '记忆版本链不匹配',
      rollback_metadata_failed: '回滚元数据失败',
      unknown_snapshot_type: '未知快照类型',
      invalid_snapshot_memory_id: '快照记忆 ID 无效',
      snapshot_missing_memory_id: '快照缺少记忆 ID',
      rollback_create_conflict: '回滚创建操作冲突',
      rollback_delete_failed: '回滚删除操作失败',
      rollback_alias_conflict: '回滚别名冲突',
      rollback_alias_failed: '回滚别名失败',
      memory_permanently_deleted: '记忆版本已被永久删除',
      rollback_restore_failed: '回滚恢复失败',
      path_no_longer_exists: '记忆路径已不存在',
      unknown_path_operation: '未知路径操作',
      rollback_content_path_missing: '回滚内容路径缺失',
      rollback_invalid_current_memory_id: '当前记忆 ID 无效',
      rollback_failed: '回滚失败',
      unknown_memory_operation: '未知记忆操作',
      unknown_resource_type: '未知审查资源类型',
      session_not_found: '未找到审查会话',
      deprecated_memory_not_found: '未找到已弃用记忆',
      deprecated_memory_delete_conflict: '删除已弃用记忆时发生冲突',
    },
    messages: {
      'job not found': '任务不存在',

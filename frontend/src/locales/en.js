const en = {
  ...
  memory: {
    ...
    layerHierarchy: {
      title: 'Memory Layers',
      subtitle: 'Explore memory hierarchy: L0 access logs, L1 atomic, L2 summaries',
      loading: 'Loading...',
      loadingDetail: 'Loading detail...',
      refresh: 'Refresh',
      mockBadge: 'Mock Data',
      layerStatsHeading: 'Layer Statistics',
      summariesHeading: 'L2 Summaries',
      noSummaries: 'No summaries available',
      provenanceHeading: 'Provenance',
      sourceMemoriesHeading: 'Source Memories',
      noSources: 'No source memories found',
      noContent: 'No content',
      noL1Loaded: 'Select a summary to view source memories',
      untitledSummary: 'Untitled summary',
      ...
      layerDescriptions: {
        L0: 'Raw interaction events',
        L1: 'Durable atomic memories',
        L2: 'Human-reviewed summaries',
      },
      reviewStates: {
        approved: 'Approved',
        draft: 'Draft',
      ...
      errors: {
        loadSummaries: 'Failed to load layer summaries',
        loadDetail: 'Failed to load detail',
      },
    },
    feedback: {
  ...
  review: {
    ...
    orphan: {
      kicker: 'Irreversible Deletion',
      title: 'Memory Fully Orphaned',
      body: 'No other paths point to this memory. Deletion will permanently remove all access, and the original content will no longer surface in search results.',
      irreversible: 'This action cannot be undone',
    },
    paths: {
      sectionLabel: 'Surviving Paths',
      summary_one: 'This memory remains reachable via {{count}} path',
      summary_other: 'This memory remains reachable via {{count}} paths',
      copy: 'Copy URI',
      copyUri: 'Copy URI {{uri}}',
      copied: 'Copied',
  ...
  maintenance: {
    ...
    tabs: {
      ...
      vitality: 'Vitality Cleanup',
      forgetting: 'Forgetting Simulation',
    },
    shared: {
      selectionSummary: '{{selected}} selected · {{actionable}} actionable',
      clearSelection: 'Clear selection',
      retry: 'Retry',
      noResults: 'No results',
      loadingCandidates: 'Loading candidates...',
      lastUpdated: 'Last scan {{time}}',
    ...
    stats: {
      ...
      forgettingHint: 'archive candidates',
    },
    ...
    orphan: {
      selectionRegion: 'Selected orphan memories',
      selectMemory: 'Select memory #{{id}} ({{label}})',
      deselectMemory: 'Deselect memory #{{id}} ({{label}})',
      selectGroup: 'Select all {{group}}',
      deselectGroup: 'Deselect all {{group}}',
    },
    ...
    vitality: {
      ...
      confirmModal: {
        ...
        body: 'You are about to {{action}} {{count}} memories. This action requires confirmation.',
        body_one: 'You are about to {{action}} {{count}} memory. This action requires confirmation.',
        body_other: 'You are about to {{action}} {{count}} memories. This action requires confirmation.',
        phrasePrompt: 'Type the confirmation phrase below to proceed:',
        cancel: 'Cancel',
        confirm: 'Confirm',
      },
      ...
      access: 'access {{value}}',
      selectCandidate: 'Select candidate #{{id}} ({{uri}})',
      deselectCandidate: 'Deselect candidate #{{id}} ({{uri}})',
      deletable: 'deletable',
      activePaths: 'active paths',
      noPath: '(no path)',
      selectionRegion: 'Selected vitality cleanup candidates',
    },
    forgetting: {
      title: 'Forgetting Simulation',
      subtitle: 'Preview memory decay and review archive candidates',
      loading: 'Loading...',
      refresh: 'Refresh',
      mockBadge: 'Mock Data',
      simulationHeading: 'Decay Simulation',
      daysLabel: 'Projection (days)',
      thresholdLabel: 'Archive threshold',
      projectedRetained: 'Projected retained',
      projectedArchived: 'Projected archived',
      decayUnavailable: 'Decay simulation data not available',
      distribution: {
      ...
      queueHeading: 'Archive Candidate Queue',
      noCandidates: 'No candidates below threshold',
      ...
      select: 'Select',
      deselect: 'Deselect',
      selectCandidate: 'Select memory #{{id}} ({{title}})',
      deselectCandidate: 'Deselect memory #{{id}} ({{title}})',
      batchKeep: 'Keep Selected',
      batchArchive: 'Archive Selected',
      unnamedMemory: 'Unnamed memory',
      confirmArchive: 'Archive {{count}} selected memory item(s)?',
      confirmArchive_one: 'Archive {{count}} selected memory?',
      confirmArchive_other: 'Archive {{count}} selected memories?',
      executeArchive: 'Type the confirmation phrase to archive selected memories:\n{{phrase}}',
      decayChartLabel: 'Decay curve for memory #{{id}}',
      outOfTotal: 'of {{count}} total',
      reason: 'Reason: {{value}}',
      selectedCount: '{{count}} selected',
      simulationDays: '{{count}} simulation days',
      simulationDays_one: '{{count}} simulation day',
      simulationDays_other: '{{count}} simulation days',
      selectionRegion: 'Selected forgetting candidates',
      recommendations: {
        archive: 'Archive',
        keep: 'Keep',
        review: 'Review',
      ...
      errors: {
        ...
        loadSimulation: 'Failed to load decay simulation',
      },
      messages: {
        archiveFailed: 'Failed to archive {{count}} memory item(s)',
        archiveFailed_one: 'Failed to archive {{count}} memory',
        archiveFailed_other: 'Failed to archive {{count}} memories',
        archived: 'Archived {{count}} memory item(s)',
        archived_one: 'Archived {{count}} memory',
        archived_other: 'Archived {{count}} memories',
        archivedMock: 'Archived {{count}} memory item(s) (mock)',
        archivedMock_one: 'Archived {{count}} memory (mock)',
        archivedMock_other: 'Archived {{count}} memories (mock)',
        inspectQueued: 'Inspect queued for memory #{{id}}',
        keepBatchFailed: 'Failed to keep {{count}} selected memory item(s)',
        keepBatchFailed_one: 'Failed to keep {{count}} selected memory',
        keepBatchFailed_other: 'Failed to keep {{count}} selected memories',
        keepFailed: 'Failed to keep memory #{{id}}',
        kept: 'Memory #{{id}} kept',
        keptBatch: 'Kept {{count}} selected memory item(s)',
        keptBatch_one: 'Kept {{count}} selected memory',
        keptBatch_other: 'Kept {{count}} selected memories',
      },
    },
  },
  observability: {
    ...
    searchQuality: {
      ...
      subtitle: 'Monitor search performance and channel contributions',
      refresh: 'Refresh',
      mockBadge: 'Mock Data',
      mrr: 'MRR@8',
      recall: 'Recall@8',
      p95: 'p95 Latency',
      mrrTrend: 'MRR Trend',
      recallTrend: 'Recall Trend',
      latencyTrend: 'Latency Trend',
      notAvailable: 'N/A',
      notEnoughData: 'Insufficient data',
      perModeHeading: 'Per-Mode Metrics',
      channelHeading: 'Channel Contributions',
      channels: {
        fts5: 'FTS5 Keyword',
      ...
      contributionExplain: 'Percentage of final results contributed by each channel',
      rrfHeading: 'RRF Configuration',
      rrfStatus: 'Status',
      rrfEnabled: 'Enabled',
      rrfDisabled: 'Disabled',
      rrfK: 'k value',
      rrfReason: 'Reason: {{value}}',
      lastUpdated: 'Last updated',
      sampleCount: 'Sample count: {{count}}',
      sparklineMax: 'Max',
      sparklineMin: 'Min',
      weight: 'Weight: {{value}}',
      windowDays: '{{count}} day window',
      timeSeriesHeading: 'Quality Over Time',
      errors: {
        loadMetrics: 'Failed to load search quality metrics',
      },
    },
    modes: {
      hybrid: 'hybrid',
  ...
  apiErrors: {
    ...
    codes: {
      ...
      config_value_invalid_line_break: 'Configuration value contains a line break',
      no_config_changes: 'No configuration changes were provided',
      ...
      invalid_domain: 'Invalid memory domain',
      read_only_domain: 'Memory domain is read-only',
      path_too_long: 'Memory path is too long',
      path_not_found: 'Memory path was not found',
      create_node_failed: 'Failed to create memory node',
      memory_version_conflict: 'Memory version conflict',
      update_node_failed: 'Failed to update memory node',
      delete_node_failed: 'Failed to delete memory node',
      invalid_session_id: 'Invalid review session ID',
      newer_review_snapshot_exists: 'A newer review snapshot exists',
      session_snapshots_not_found: 'Review session snapshots were not found',
      snapshot_not_found: 'Review snapshot was not found',
      version_chain_mismatch: 'Memory version chain mismatch',
      rollback_metadata_failed: 'Failed to roll back metadata',
      unknown_snapshot_type: 'Unknown snapshot type',
      invalid_snapshot_memory_id: 'Invalid snapshot memory ID',
      snapshot_missing_memory_id: 'Snapshot is missing memory ID',
      rollback_create_conflict: 'Rollback create conflict',
      rollback_delete_failed: 'Rollback delete failed',
      rollback_alias_conflict: 'Rollback alias conflict',
      rollback_alias_failed: 'Rollback alias failed',
      memory_permanently_deleted: 'Memory version was permanently deleted',
      rollback_restore_failed: 'Rollback restore failed',
      path_no_longer_exists: 'Memory path no longer exists',
      unknown_path_operation: 'Unknown path operation',
      rollback_content_path_missing: 'Rollback content path is missing',
      rollback_invalid_current_memory_id: 'Current memory ID is invalid',
      rollback_failed: 'Rollback failed',
      unknown_memory_operation: 'Unknown memory operation',
      unknown_resource_type: 'Unknown review resource type',
      session_not_found: 'Review session was not found',
      deprecated_memory_not_found: 'Deprecated memory was not found',
      deprecated_memory_delete_conflict: 'Deprecated memory delete conflict',
    },
    messages: {
